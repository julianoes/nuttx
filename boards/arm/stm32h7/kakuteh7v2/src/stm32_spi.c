/****************************************************************************
 * boards/arm/stm32h7/kakuteh7v2/src/stm32_spi.c
 *
 ...
 *
 * Description:
 *   Called to configure SPI chip select GPIO pins for the kakuteh7v2 board.
 *
 ****************************************************************************/

void stm32_spidev_initialize(void)
{
  stm32_configgpio(GPIO_W25N_CS);
}
 ...
 *      pins.
 *   2. Provide stm32_spi1select() and stm32_spi1status() functions in your
                      ...
                      uint32_t devid, bool selected)
{
  ...
  if (devid == SPIDEV_FLASH(0))
    {
      stm32_gpiowrite(GPIO_W25N_CS, !selected);
    }
}
